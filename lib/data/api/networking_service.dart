...
class NetworkingService {
  final SharedPrefServices _prefServices;

  final String baseUrl;
  final Dio _userDio;
  final Dio _publicDio;

  NetworkingService({required SharedPrefServices prefServices,@Named('baseUrl') required this.baseUrl, required Dio userDio, required Dio publicDio}) : _prefServices = prefServices, _userDio = userDio, _publicDio = publicDio;
